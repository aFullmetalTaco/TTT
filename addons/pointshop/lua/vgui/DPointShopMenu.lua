surface.CreateFont('PS_Heading', { font = 'coolvetica', size = 52 })
surface.CreateFont('PS_Heading2', { font = 'coolvetica', size = 21 })
...
function PANEL:Paint()
	...
	draw.SimpleText('GamingVortex Shop', 'PS_Heading', 20, 10, color_white)
	draw.SimpleText('Become a donator at gamingvortex.co', 'PS_Heading2', 275, 60, color_white)
